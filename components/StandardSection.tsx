...
const StandardSection: React.FC = () => {
  ...
  return (
    <section id="standard-details" ref={sectionRef} className="w-full bg-[radial-gradient(circle_at_top_right,_#0d0d0d_0%,_#050505_100%)] pt-12 pb-8 px-8 border-t border-white/5 overflow-hidden">
      {/* Animation Styles */}
      <style>{`
        @keyframes spin-slow {
  ...
  with a touch-ready project.
              ...
              <div className="pt-2 space-y-6">
                ...
                <div className="pt-6">
                  {/* Updated Link with Cyan Neon Border */}
