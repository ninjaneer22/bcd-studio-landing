...
const ComparisonTable: React.FC = () => {
  ...
  // State to track if we should show the "scroll hint" for each table
  ...
  const handleScroll = (e: React.UIEvent<HTMLDivElement>, setFade: (val: boolean) => void) => {
    ...
    // Hide fade if we are within 20px of the end
      ...
      <div className="max-w-6xl mx-auto space-y-32">
        ...
        <div className="text-center space-y-4">
          ...
          <h2 className="table-row-reveal text-3xl md:text-5xl font-bold text-google-white tracking-tight">
            Logic Essentials. Total Studio Control.
          </h2>
        </div>

        {/* Workflow Profile Table */}
        <div className="relative group">
          <div 
            className="overflow-x-auto custom-scrollbar"
            onScroll={(e) => handleScroll(e, setShowFade1)}
          >
        ...
        <div className="relative group">
          <div 
            ...
            onScroll={(e) => handleScroll(e, setShowFade2)}
          >
            <table className="w-full text-left border-collapse min-w-[700px]">
              <thead>
                <tr className="border-b border-white/10">
